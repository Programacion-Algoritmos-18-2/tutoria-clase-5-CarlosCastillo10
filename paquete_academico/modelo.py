...
class EstPresencial(Estudiante):#Clase hija que era de la clase padre ("Estudiante")
    ...
    def presentar_datos(self):
        ...
        cadena = "\nReporte\n\n%s %s-%d\nCiclo: %s\nCreditos: %d\nPertenece a ciudad %s, con una poblacion de %d\n" %(self.obtener_nombre(),self.obtener_apellido()
            ,self.obtener_id_estudiante(),self.obtener_ciclo(),self.obtener_num_creditos(),self.obtener_ciudad().obtener_nombre(),self.obtener_ciudad().obtener_poblacion())
